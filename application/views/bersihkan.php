...
<div class="btn-group" role="group" aria-label="Basic example">
	<a onClick="if(!confirm('Yakin untuk melanjutkan?')){return false;}" href="<?=base_url('clean');?>"><button type="button" class="btn btn-danger btn-flat">YA, BERSIHKAN SEKARANG</button></a> &nbsp; 
	<a href="<?=base_url('home');?>"><button type="button" class="btn btn-primary btn-flat">TIDAK, JANGAN SEKARANG</button></a>
</div>